...
export interface VotingInstance extends Truffle.ContractInstance {
  ...
  /**
   * Anyone can consult final voting result. The result contains winning proposals but also informations about blank votes, abstention and total registered voters count.
   */
  result(
    txDetails?: Truffle.TransactionDetails
  ...
  /**
   * Each voter can register many proposals. As we consider the vote will be done in small organization context, we limit the maximum number of proposals to 256 here. Votes can be added only by registered voter when `status` is set to VotingSessionStarted
