...
contract('Voting', (accounts) => {
    ...
    describe('> Some access controls prevent functions to be called by non owners', () => {
        ...
        describe('> createVotingSession', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.createVotingSession('test', 'test', { from: batman }), 
                    'Ownable: caller is not the owner');
            });

            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.createVotingSession('test', 'test', { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> registerVoter', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.registerVoter(sessionId, superman, { from: batman }), 
                    'Ownable: caller is not the owner');
            });

            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.registerVoter(sessionId, superman, { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> startProposalsRegistration', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.startProposalsRegistration(sessionId, { from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.startProposalsRegistration(sessionId, { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> stopProposalsRegistration', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.stopProposalsRegistration(sessionId, { from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.stopProposalsRegistration(sessionId, { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> startVotingSession', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.startVotingSession(sessionId, { from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.startVotingSession(sessionId, { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> stopVotingSession', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.stopVotingSession(sessionId, { from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.stopVotingSession(sessionId, { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> tallyVotes', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.tallyVotes(sessionId, { from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.tallyVotes(sessionId, { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
    ...
    describe('> Voting actions are conditionned by voting session status', () => {
        ...
        beforeEach(async () => {
            votingInstance = await Voting.new({ from: administrator });
            await votingInstance.createVotingSession('Super Heroes', 'A vote for every superheroes to find who will rule the world');
            await votingInstance.registerVoter(sessionId, batman, { from: administrator });
        });
        ...
        context('## voting status is RegisteringVoters', () => {
            ...
            describe('> createVotingSession', () => {
                it('> should succeed when called with contract owner address', async () => {
                    const receipt = await votingInstance.createVotingSession('session\'s name', 'session\'s description', { from: administrator });
            ...
            describe('> registerVoter', () => {
                it('> should succeed when called with contrat owner address', async () => {
                    const receipt = await votingInstance.registerVoter(sessionId, superman, { from: administrator });
            ...
            describe('> startProposalsRegistration', () => {
                it('> should succeed when called with contrat owner address', async () => {
                    const receipt = await votingInstance.startProposalsRegistration(sessionId, { from: administrator });
            ...
            context('## voting status is ProposalsRegistrationStarted', () => {
                ...
                beforeEach(async () => {
                    await votingInstance.startProposalsRegistration(sessionId, { from: administrator });
                    await votingInstance.registerProposal(sessionId, 'Bats should replace all dogs', { from: batman });
                });
                ...
                describe('> stopProposalsRegistration', () => {
                    it('> should succeed when called with contrat owner address', async () => {
                        const receipt = await votingInstance.stopProposalsRegistration(sessionId, { from: administrator });
                ...
                describe('> registerProposal', () => {
                    ...
                    it('> should succeed when called with registered voter address', async () => {
                        ...
                        const receipt = await votingInstance.registerProposal(sessionId, batmanProposal, { from: batman });
                        await expectEvent(receipt, 'ProposalRegistered', {
                            sessionId: BN(sessionId),
                    ...
                    it('> should fail when called more times than maximum allowed', async () => {
                        await expectEvent(await votingInstance.registerProposal(sessionId, 'We would never put the light in the streets', { from: batman }), 
                            'ProposalRegistered', {
                                sessionId: BN(sessionId),
                                proposalId: BN(3), // expect 4rd element as abstention, blank and first batman vote have been registered before
                            });

                        await expectEvent(await votingInstance.registerProposal(sessionId, 'We should hang Robin', { from: batman }), 
                            'ProposalRegistered', {
                                sessionId: BN(sessionId),
                ...
                context('## voting status is ProposalsRegistrationStopped', () => {
                    ...
                    beforeEach(async () => {
                        await votingInstance.stopProposalsRegistration(sessionId, { from: administrator });
                    });
                    ...
                    describe('> startVotingSession', () => {
                        it('> should succeed when called with contrat owner address', async () => {
                            const receipt = await votingInstance.startVotingSession(sessionId, { from: administrator });
                    ...
                    context('## voting status is VotingSessionStarted', () => {
                        ...
                        beforeEach(async () => {
                            await votingInstance.startVotingSession(sessionId, { from: administrator });
                        });
                        ...
                        describe('> stopVotingSession', () => {
                            it('> should succeed when called with contrat owner address', async () => {
                                const receipt = await votingInstance.stopVotingSession(sessionId, { from: administrator });
                        ...
                        describe('> vote', () => {
                            it('> should succeed when called with registered voter address', async () => {
                                const receipt = await votingInstance.vote(sessionId, 1, { from: batman });
                        ...
                        context('## voting status is VotingSessionEnded', () => {
                            ...
                            beforeEach(async () => {
                                await votingInstance.stopVotingSession(sessionId, { from: administrator });
                            });
                            ...
                            describe('> tallyVotes', () => {
                                it('> should succeed when called with contrat owner address', async () => {
                                    const receipt = await votingInstance.tallyVotes(sessionId, { from: administrator });
                                    await expectEvent(receipt, 'WorkflowStatusChange', {
                                        sessionId: BN(sessionId),
                                        previousStatus: BN(expectedStatus),
                                        newStatus: BN(expectedStatus + 1),
                            ...
                            context('## voting status is VotesTallied', () => {
                                ...
                                beforeEach(async () => {
                                    await votingInstance.tallyVotes(sessionId, { from: administrator });
                                });
    ...
    describe('> A complete super heroes voting session', () => {
        ...
        before(async () => {
            ...
            await votingInstance.registerVoter(sessionId, batman, { from: administrator });
            await votingInstance.registerVoter(sessionId, wonderwoman, { from: administrator });
            await votingInstance.registerVoter(sessionId, acquaman, { from: administrator });
            await votingInstance.registerVoter(sessionId, ironman, { from: administrator });
            await votingInstance.registerVoter(sessionId, antman, { from: administrator });
            await votingInstance.registerVoter(sessionId, spiderman, { from: administrator });
            ...
            await votingInstance.registerProposal(sessionId, 'Humans should serve cryptonian people !!', { from: superman }); // 2
            await votingInstance.registerProposal(sessionId, 'Cryptonian people should serve me', { from: superman });  // 3
            await votingInstance.registerProposal(sessionId, 'We would never put the light in the streets', { from: batman });  // 4
            await votingInstance.registerProposal(sessionId, 'Only women should be allowed to vote here next time', { from: wonderwoman }); // 5
            await votingInstance.registerProposal(sessionId, 'We should make a big tsunami!', { from: acquaman }); // 6
    ...
    describe('> Many parallel voting sessions', () => {
        ...
        before(async () => {
            ...
            await votingInstance.registerVoter(s1, wonderwoman, { from: administrator });
            ...
            await votingInstance.registerVoter(s0, spiderman, { from: administrator });
            await votingInstance.startProposalsRegistration(s0);
            await votingInstance.registerVoter(s1, spiderman, { from: administrator });
            await votingInstance.startProposalsRegistration(s1);
            await votingInstance.registerProposal(s0, 'Humans should serve cryptonian people !!', { from: superman });
            await votingInstance.registerProposal(s1, 'We need to show to the world that super women are better than men', { from: spiderman });
            await votingInstance.registerProposal(s0, 'All supers should stop calling me little girl', { from: spiderman });
            ...
            await votingInstance.registerProposal(s1, 'Voting should be forbidden to men', { from: wonderwoman });
        ...
        it('> should allow to get all registered voter addresses with events filtering on sessionId', async () => {
            const s0_events = (await votingInstance.getPastEvents('VoterRegistered', { 
                fromBlock: 0,
                filter: { sessionId: BN(s0) },
             })).map(mapVoterRegisteredEvent);
            
            assert.sameMembers(s0_events, [superman, ironman, antman, batman, spiderman]);
            
            const s1_events = (await votingInstance.getPastEvents('VoterRegistered', { 
                fromBlock: 0,
        ...
        it('> should allow to get all registered proposal ids with events filtering on sessionId', async () => {
            const s0_events = (await votingInstance.getPastEvents('ProposalRegistered', { 
                fromBlock: 0,
                filter: { sessionId: BN(s0) },
             })).map(mapProposalRegisteredEvent);
            ...
            const s1_events = (await votingInstance.getPastEvents('ProposalRegistered', { 
                fromBlock: 0,
                filter: { sessionId: BN(s1) },
             })).map(mapProposalRegisteredEvent);
             ...
             assert.sameDeepMembers(s1_events, [{
                ...
                proposalId: 2,
                description: 'We need to show to the world that super women are better than men',
            }, {
                proposalId: 3,
        ...
        it('> should allow to get all voters addresses that have voted with events filtering on sessionId', async () => {
            const s0_events = (await votingInstance.getPastEvents('Voted', { 
                fromBlock: 0, 
                filter: { sessionId: BN(s0) },
             })).map(mapVotedEvent);
            ...
            const s1_events = (await votingInstance.getPastEvents('Voted', { 
                fromBlock: 0, 
                filter: { sessionId: BN(s1) },
             })).map(({ returnValues }) => returnValues.voter);
        ...
        it('> should allow to get the voting session result with events filtering on sessionId', async () => {
            const [s0_events] = (await votingInstance.getPastEvents('VotesTallied', { 
                fromBlock: 0,
                filter: { sessionId: BN(s0) },
             })).map(mapVotesTalliedEvent);
            ...
            const [s1_events] = (await votingInstance.getPastEvents('VotesTallied', { 
                fromBlock: 0,
                filter: { sessionId: BN(s1) },
             })).map(mapVotesTalliedEvent);
