...
import { VotingAlyraInstance } from "../types/truffle/VotingAlyra";

const VotingAlyra = artifacts.require('VotingAlyra');

const mapProposalRegisteredEvent = ({ returnValues }) => +returnValues.proposalId;
...
contract('VotingAlyra', (accounts) => {
    ...
    describe('> onlyOwner modifer prevents functions to be called by non owners', () => {
        ...
        describe('> addVoter', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.addVoter(superman, { from: batman }), 
                    'Ownable: caller is not the owner');
            });

            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.addVoter(superman, { from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> startProposalsRegistering', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.startProposalsRegistering({ from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.startProposalsRegistering({ from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> endProposalsRegistering', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.endProposalsRegistering({ from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.endProposalsRegistering({ from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> startVotingSession', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.startVotingSession({ from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.startVotingSession({ from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> endVotingSession', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.endVotingSession({ from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.endVotingSession({ from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
        ...
        describe('> tallyVotes', () => {
            it('> should fail when called with registered voter address', async () => {
                await expectRevert(votingInstance.tallyVotes({ from: batman }), 
                    'Ownable: caller is not the owner');
            });
            
            it('> should fail when called with non registered voter address', async () => {
                await expectRevert(votingInstance.tallyVotes({ from: superman }), 
                    'Ownable: caller is not the owner');
            });
        });
    });
    ...
    describe('> onlyVoters modifier prevents functions to be called by non voters', () => {
        ...
        describe('> getVoter', () => {
            it('> should fail when called with non registered voter', async () => {
                await expectRevert(votingInstance.getVoter(batman, { from: superman }), 
                    `You're not a voter`);
            });
          
            it('> should fail when called with contrat owner address', async () => {
                await expectRevert(votingInstance.getVoter(batman, { from: administrator }),
                    `You're not a voter`);
            });
        });
        ...
        describe('> getOneProposal', () => {
            it('> should fail when called with non registered voter', async () => {
                await expectRevert(votingInstance.getOneProposal(0, { from: superman }), 
                    `You're not a voter`);
            });
          
            it('> should fail when called with contrat owner address', async () => {
                await expectRevert(votingInstance.getOneProposal(0, { from: administrator }),
                    `You're not a voter`);
            });
        });
        ...
        describe('> addProposal', () => {
            it('> should fail when called with non registered voter', async () => {
                await expectRevert(votingInstance.addProposal('fake proposal', { from: superman }), 
                    `You're not a voter`);
            });
          
            it('> should fail when called with contrat owner address', async () => {
                await expectRevert(votingInstance.addProposal('fake proposal', { from: administrator }),
                    `You're not a voter`);
            });
        });
        ...
        describe('> setVote', () => {
            it('> should fail when called with non registered voter', async () => {
                await expectRevert(votingInstance.setVote(0, { from: superman }), 
                    `You're not a voter`);
            });
          
            it('> should fail when called with contrat owner address', async () => {
                await expectRevert(votingInstance.setVote(0, { from: administrator }),
                    `You're not a voter`);
            });
        });
    });
    ...
    describe('> everybody can call public storage getters', () => {
        ...
        describe('> winningProposalID', () => {
            ...
            it('> should succeed when called with registered voter', async () => {
                assert.equal((await votingInstance.winningProposalID({ from: batman })).toNumber(), 0);
            });
          
            it('> should succeed when called with contrat owner address', async () => {
                assert.equal((await votingInstance.winningProposalID({ from: administrator })).toNumber(), 0);
            });
        });

        describe('> workflowStatus', () => {
            it('> should succeed when called with non registered voter', async () => {
                assert.equal((await votingInstance.workflowStatus({ from: superman })).toNumber(), 0);
            });

            it('> should succeed when called with registered voter', async () => {
                assert.equal((await votingInstance.workflowStatus({ from: batman })).toNumber(), 0);
            });
          
            it('> should succeed when called with contrat owner address', async () => {
                assert.equal((await votingInstance.workflowStatus({ from: administrator })).toNumber(), 0);
            });
        });
    });
    ...
    describe('> Voting actions are conditionned by voting session status', () => {
        ...
        context('## voting status is RegisteringVoters', () => {
            ...
            describe('> addVoter', () => {
                it('> should succeed when called with contrat owner address', async () => {
                    const receipt = await votingInstance.addVoter(superman, { from: administrator });
                    await expectEvent(receipt, 'VoterRegistered', {
                        voterAddress: superman,
                    });
                    const addedVoter = await votingInstance.getVoter(superman, { from: batman });
                ...
                it('> should fail when voter address is already registered', async () => {
                    await expectRevert(votingInstance.addVoter(batman, { from: administrator }), 
                        'Already registered');
                });
            });
            ...
            describe('> startProposalsRegistering', () => {
                it('> should succeed when called with contrat owner address', async () => {
                    const receipt = await votingInstance.startProposalsRegistering({ from: administrator });
                    await expectEvent(receipt, 'WorkflowStatusChange', {
                        previousStatus: BN(expectedStatus),
                        newStatus: BN(expectedStatus + 1),
                    });
                    assert.equal((await votingInstance.workflowStatus()).toNumber(), expectedStatus + 1);
                });
            });

            describe('> endProposalsRegistering', () => {            
                it('> should fail when called with contrat owner address', async () => {
                    await expectRevert(votingInstance.endProposalsRegistering({ from: administrator }), 
            ...
            describe('> startVotingSession', () => {
                it('> should fail when called with contrat owner address', async () => {
                    await expectRevert(votingInstance.startVotingSession({ from: administrator }), 
            ...
            describe('> endVotingSession', () => {
                it('> should fail when called with contrat owner address', async () => {
                    await expectRevert(votingInstance.endVotingSession({ from: administrator }), 
            ...
            describe('> addProposal', () => {
                it('> should fail when called with registered voter address', async () => {
                    await expectRevert(votingInstance.addProposal('We would never put the light in the streets', { from: batman }), 
            ...
            describe('> setVote', () => {
                it('> should fail when called with registered voter address', async () => {
                    await expectRevert(votingInstance.setVote(1, { from: batman }),
                        'Voting session havent started yet');
                });
            });
            ...
            describe('> tallyVotes', () => {   
                it('> should fail when called with contrat owner address', async () => {
                    await expectRevert(votingInstance.tallyVotes({ from: administrator }), 
                        'Current status is not voting session ended');
                });
            });

            context('## voting status is ProposalsRegistrationStarted and we already have one proposal', () => {
                ...
                describe('> addVoter', () => {
                    it('> should fail as session status is not RegisteringVoters', async () => {
                        await expectRevert(votingInstance.addVoter(superman, { from: administrator }), 
                ...
                describe('> startProposalsRegistering', () => {
                    it('> should fail when called with contrat owner address', async () => {
                        await expectRevert(votingInstance.startProposalsRegistering({ from: administrator }), 
                ...
                describe('> endProposalsRegistering', () => {
                    it('> should succeed when called with contrat owner address', async () => {
                        const receipt = await votingInstance.endProposalsRegistering({ from: administrator });
                        await expectEvent(receipt, 'WorkflowStatusChange', {
                            previousStatus: BN(expectedStatus),
                            newStatus: BN(expectedStatus + 1),
                        });
                ...
                describe('> addProposal', () => {
                    it('> should succeed when called with registered voter address', async () => {
                        ...
                        const receipt = await votingInstance.addProposal(batmanProposal, { from: batman });
                        ...
                        const addedProposal = await votingInstance.getOneProposal(expectedProposalId, { from: batman });
                ...
                context('## voting status is ProposalsRegistrationStopped', () => {
                    ...
                    context('## voting status is VotingSessionStarted', () => {
                        ...
                        describe('> endVotingSession', () => {
                            it('> should succeed when called with contrat owner address', async () => {
                                const receipt = await votingInstance.endVotingSession({ from: administrator });
                                await expectEvent(receipt, 'WorkflowStatusChange', {
                                    previousStatus: BN(expectedStatus),
                                    newStatus: BN(expectedStatus + 1),
                                });
                        ...
                        describe('> setVote', () => {
                            ...
                            it('> should fail when called with registered voter address who votes for a non registered proposal', async () => {
                                await expectRevert(votingInstance.setVote(2, { from: batman }), 
                                    'Proposal not found');
                            });
                        });
                        ...
                        context('## voting status is VotingSessionEnded', () => {
                            ...
                            describe('> tallyVotes', () => {
                                it('> should succeed when called with contrat owner address', async () => {
                                    const receipt = await votingInstance.tallyVotes({ from: administrator });
                                    await expectEvent(receipt, 'WorkflowStatusChange', {
                                        previousStatus: BN(expectedStatus),
                                        newStatus: BN(expectedStatus + 1),
                                    });
    ...
    describe('> A complete super heroes voting session', () => {
        ...
        before(async () => {
            ...
            await votingInstance.addProposal('Humans should serve cryptonian people !!', { from: superman }); // 2
            await votingInstance.addProposal('Cryptonian people should serve me', { from: superman });  // 3
            await votingInstance.addProposal('We would never put the light in the streets', { from: batman });  // 4
            await votingInstance.addProposal('Only women should be allowed to vote here next time', { from: wonderwoman }); // 5
            await votingInstance.addProposal('We should make a big tsunami!', { from: acquaman }); // 6
        ...
        it('> should allow to get a voter and his chosen proposal ID', async () => {
            assert.equal((await votingInstance.getVoter(superman, { from: superman })).votedProposalId, BN(3));
            assert.equal((await votingInstance.getVoter(batman, { from: superman })).votedProposalId, BN(2));
            assert.equal((await votingInstance.getVoter(wonderwoman, { from: superman })).votedProposalId, BN(3));
            assert.equal((await votingInstance.getVoter(acquaman, { from: superman })).votedProposalId, BN(1));
            assert.equal((await votingInstance.getVoter(ironman, { from: superman })).votedProposalId, BN(5));
            assert.equal((await votingInstance.getVoter(antman, { from: superman })).votedProposalId, BN(0));
            assert.equal((await votingInstance.getVoter(spiderman, { from: superman })).votedProposalId, BN(4));
        });

        it('> should allow to get a proposal with corresponding description and votes count', async () => {
            assert.equal((await votingInstance.getOneProposal(0, { from: superman })).description, 'GENESIS');
            assert.equal((await votingInstance.getOneProposal(1, { from: superman })).description, 'Humans should serve cryptonian people !!');
            assert.equal((await votingInstance.getOneProposal(2, { from: superman })).description, 'Cryptonian people should serve me');
            assert.equal((await votingInstance.getOneProposal(3, { from: superman })).description, 'We would never put the light in the streets');
            assert.equal((await votingInstance.getOneProposal(4, { from: superman })).description, 'Only women should be allowed to vote here next time');
            assert.equal((await votingInstance.getOneProposal(5, { from: superman })).description, 'We should make a big tsunami!');
        });
        ...
        it('> should allow to get all registered voter addresses with events', async () => {
            const events = (await votingInstance.getPastEvents('VoterRegistered', { 
                fromBlock: 0, 
                toBlock: blockNumberBeforeProposalsRegistration,
             })).map(mapVoterRegisteredEvent);
            
            assert.sameMembers(events, [superman, batman, wonderwoman, acquaman, ironman, antman, spiderman]);
        });

        it('> should allow to get all registered proposal ids with events', async () => {
            const events = (await votingInstance.getPastEvents('ProposalRegistered', { 
        ...
        it('> should allow to get all voters addresses that have voted with events', async () => {
            const events = (await votingInstance.getPastEvents('Voted', { 
