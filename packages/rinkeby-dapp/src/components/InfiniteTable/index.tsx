...
export default (props: IProps) => {
	...
	return (
		<StyledInfiniteLoader
			...
			loadMoreRows={() =>
				loadMoreRows && rows.length < totalRows
					? Promise.resolve(dispatch(loadMoreRows()))
					: Promise.resolve()
			}
			rowCount={totalRows}
					...
					>
						...
						>
							{columns.map((column) => {
								return (
									<Column
										key={`column-left-${column.dataKey}`}
										{...column}
