...
import { getContractInfo, IDynamicContractImportDefinitions } from 'src/eth-network/helpers';
...
export async function getVotingContract(web3: Web3): Promise<contracts.Voting> {
  ...
  console.log("voting contract address", contractInfo.address);
  return new web3.eth.Contract(contractInfo.abi, contractInfo.address) as unknown as contracts.Voting
}