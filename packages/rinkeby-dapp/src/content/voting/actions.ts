...
export const VOTING_SESSION_ADDED = createAction(
...
export const VOTING_SESSION_STATUS_CHANGED = createAction(
...
export const PROPOSAL_REGISTERED = createAction(
	'PROPOSAL_REGISTERED',
	(action) => {
...
export const CLEAR_CREATE_VOTING_SESSION_TX_ERROR = createAction(
