...
import { LISTEN_VOTING_SESSION_CREATED, LIST_VOTING_SESSIONS } from '../../actions';
...
export default () => {
    ...
    const { txPending: loading, sessions } = useSelector((state: RootState) => state.voting);
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell align={'right'}>
                                            <VotingSessionListItemActions currentView={'list'} sessionId={session.id} capabilities={session.$capabilities}/>
                                        </TableCell>
                                    </TableRow>
                                );
                            })}
