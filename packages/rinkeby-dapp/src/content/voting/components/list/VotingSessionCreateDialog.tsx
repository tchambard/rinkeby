...
import { CREATE_VOTING_SESSION, ICreateVotingSessionParams } from '../../actions';
...
export default ({ dialogVisible, setDialogVisible }: IVoterSessionCreateDialogProps) => {
    ...
    return <Dialog
        ...
        open={dialogVisible}
    >
        <DialogTitle id={'new-voting-session-title'}>{'Create new session'}</DialogTitle>
        <DialogContent dividers>
          <FormContainer defaultValues={formData} onSuccess={(data: ICreateVotingSessionParams) => {
            setFormData(data);
