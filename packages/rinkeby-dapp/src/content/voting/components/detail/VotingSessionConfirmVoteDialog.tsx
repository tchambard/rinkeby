...
export default ({ proposal, dialogVisible, setDialogVisible }: IConfirmVoteDialogProps) => {
    ...
    >
        ...
        <DialogContent dividers>
          <FormContainer onSuccess={() => {
            dispatch(VOTE.request({ sessionId: currentSession.item.id, proposalId: proposal.proposalId }));
