...
export default ({ dialogVisible, setDialogVisible }: IAddVoterDialogProps) => {
    ...
    >
        ...
        <DialogContent dividers>
          <FormContainer defaultValues={formData} onSuccess={(data: IRegisterVoterParams) => {
            setFormData(data);
            dispatch(REGISTER_VOTER.request({ sessionId: currentSession.item.id, address: data.address }));
